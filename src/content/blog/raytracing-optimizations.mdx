...
![Scene with three spheres](/src/assets/raytracing-optimizations/three-spheres.png)
...
![big raytraced scene with hundreds of balls](/src/assets/raytracing-optimizations/big-scene.png)
...
![Raytraced image of the cornell box](/src/assets/raytracing-optimizations/cornell-box.png)
...
![image of a sphere with perlin noise texture and above it a sphere with a texture that looks like the earth](/src/assets/raytracing-optimizations/perlin-and-earth.png)
...
![Graph of the performance improvements](/src/assets/raytracing-optimizations/graph1.png)

We can't see much after the multithreading, so let's zoom in a bit.

![Graph of the performance improvement](/src/assets/raytracing-optimizations/graph2.png)
