...
![Picture of the demo scene of my renderer](/src/assets/opengl-scene/chat.jpg)
...
![graph on how the scene graph is layed out](/src/assets/opengl-scene/scene-graph.svg)
...
![fragPos](/src/assets/opengl-scene/fragPos.png)

![ambientOcclusion](/src/assets/opengl-scene/ambientOcclusion.png)

Then in the second attachment, the normals in view-space and the roughness are stored.

![normal](/src/assets/opengl-scene/normal.png)

![roughness](/src/assets/opengl-scene/roughness.png)

And in the third attachment, we have the base color and the metallic.

![baseColor](/src/assets/opengl-scene/baseColor.png)

![metallic](/src/assets/opengl-scene/metallic.png)
...
![ssao](/src/assets/opengl-scene/ssao.png)

Then, the four levels of the cascaded shadow maps are rendered. (I'll only show two of them.)

![lightDepth](/src/assets/opengl-scene/lightDepth.png)

![lightDepth2](/src/assets/opengl-scene/lightDepth2.png)
...
![ambientLighting](/src/assets/opengl-scene/ambient.png)

Then the point light (yes it's very similar):

![pointLight](/src/assets/opengl-scene/pointLight.png)

And finally the directional light:

![directionalLight](/src/assets/opengl-scene/directional.png)
...
![skybox](/src/assets/opengl-scene/skybox.png)

Then bloom is rendered.

![bloom](/src/assets/opengl-scene/bloom.png)
...
![final](/src/assets/opengl-scene/final.png)
...
![bob omb](/src/assets/opengl-scene/bobomb.jpg)

![cursed](/src/assets/opengl-scene/cursed.png)

![spike](/src/assets/opengl-scene/spike.png)

_and the full IBL developed integral because why not_

![ibl](/src/assets/opengl-scene/ibl.png)
